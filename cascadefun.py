...
def cascade_resolved() -> str:
    ...
    match number_revealed:
        case 1|2|3 if surprise_factor <=10:
            ...
            return 'You Revealed Bainstorm after fli... wait is this Legacy? I miss shadless BUG :('
        ...
        case _ if surprise_factor == 1:
            return  alternate_cascade("Living End",num) + " It's a little late now but maybe look into sleeves for the future."
        case _:
